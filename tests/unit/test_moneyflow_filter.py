...
class TestTodayBonusTier:
    ...
    @pytest.mark.parametrize(
        ...
        [
            # 赤天化真实例：221.16 万元 / 1408139 千元 → 0.157% → +3
            (221.16, 1_408_139.0, 3),
            # 边界：0.3% 即 amount=net_mf*1000/0.3 = 3333 倍
            (300.0, 1_000_000.0, 10),     # 1000 * 300 / 1_000_000 = 0.3% 边界
            # 1% 边界
            (1000.0, 1_000_000.0, 18),    # 1.0% 边界
            # 5% 边界
            (5000.0, 1_000_000.0, 25),    # 5.0% 边界
            (10000.0, 1_000_000.0, 25),   # 10% 也是 +25
            # 0.5% 中等
            (500.0, 1_000_000.0, 10),
            # 净流出
            (-100.0, 1_000_000.0, 0),
            (0.0, 1_000_000.0, 0),
        ],
